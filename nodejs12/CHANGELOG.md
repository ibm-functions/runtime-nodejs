...
NodeJS version:
  - [12.22.7](https://nodejs.org/en/blog/release/v12.22.7/)
...
# 1.1.1 
NodeJS version:
  - [12.22.1](https://nodejs.org/en/blog/release/v12.22.1/)

# 1.1.0
Changes:
  - update @cloudant/cloudant from `4.2.4` to `4.3.1`
  - update @ibm-functions/iam-token-manager from `1.0.4` to `1.0.5`
  - update ibm-cos-sdk from `1.6.0` to `1.10.0`
  - update ibm_db from `2.7.0` to `2.7.3`
  - update ibm-watson from `5.6.0` to `6.0.4`
  - update pug from `3.0.0` to `3.0.2`
...
NPM Packages:
  ...
  - [ibm-watson v6.0.4](https://www.npmjs.com/package/ibm-watson) - A node.js client library to use the Watson APIs.
