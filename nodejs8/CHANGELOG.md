...
## 1.6.0
Changes:
  - update openwhisk from `3.12.0` to `3.13.0`
  - update elasticsearch from `14.1.0` to `14.2.0`
  - update express from `4.16.2` to `4.16.3`
  - update pug from `2.0.0` to `2.0.1`
  - update request from `2.83.0` to `2.85.0`
  - update twilio from `3.13.0` to `3.13.1`
  - update watson-developer-cloud from `3.0.7` to `3.1.1`
...
NPM Packages:
  ...
  - [elasticsearch v14.2.0](https://www.npmjs.com/package/elasticsearch) - The official low-level Elasticsearch client for Node.js.
  ...
  - [pug v2.0.1](https://www.npmjs.com/package/pug) - Implements the Pug templating language.
  ...
  - [twilio v3.13.1](https://www.npmjs.com/package/twilio) - A wrapper for the Twilio API, related to voice, video, and messaging.
  ...
  - [watson-developer-cloud v3.1.1](https://www.npmjs.com/package/watson-developer-cloud) - Node.js client library to use the Watson Developer Cloud services, a collection of APIs that use cognitive computing to solve complex problems.
