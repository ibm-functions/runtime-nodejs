...
NPM Packages:
  ...
  - [socket.io v2.1.0](https://www.npmjs.com/package/socket.io) - Socket.IO enables real-time bidirectional event-based communication.
  - [socket.io-client v2.1.0](https://www.npmjs.com/package/socket.io-client) - Client-side support for Socket.IO.
